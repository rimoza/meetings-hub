          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                {getStatusBadge(
                  diagnostics?.hasPermission || false,
                  "Granted",
                  "Denied",
                )}
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                ...
                {getStatusBadge(
                  diagnostics?.hasServiceWorker || false,
                  "Available",
                  "Unavailable",
                )}
              </div>
        ...
        {debugMode && (
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <p className="text-sm text-blue-700">
              Check the browser console for detailed logging information. Debug
              mode will persist across page reloads.
            </p>
          </div>
        )}
      </CardContent>
