...
export function MeetingFilters({ filters, onFiltersChange }: MeetingFiltersProps) {
  return (
    <div className="flex flex-col sm:flex-row gap-4 mb-6">
      <div className="relative flex-1">
        <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4" />
        <Input
          placeholder="Search by attendee or location..."
      ...
      <Select value={filters.priority} onValueChange={(value: any) => onFiltersChange({ ...filters, priority: value })}>
        <SelectTrigger className="w-full sm:w-[140px]">
