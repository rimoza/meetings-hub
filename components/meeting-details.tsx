...
export function MeetingDetails({
  ...
  const endTime = new Date(
    meetingDateTime.getTime() + meeting.duration * 60000,
  );
              ...
              <div className="flex items-start gap-3 flex-1">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-3">
                    ...
                    >
                      <span
                        className={`w-2 h-2 rounded-full mr-1.5 ${priorityConfig[meeting.priority].dot}`}
                      />
                ...
                <div className="flex items-center gap-3 p-3 bg-secondary/30 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {meeting.time} - {formattedEndTime} ({meeting.duration}{" "}
                      minutes)
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-3 p-3 bg-secondary/30 rounded-lg border-2 border-dashed border-primary/30">
                    <div className="space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        <Select
                          value={noteType}
                          onValueChange={(value: "regular" | "follow-up") =>
                            setNoteType(value)
                          }
                        >
                  ...
                  {meeting.meetingNotes && meeting.meetingNotes.length > 0
                    ? meeting.meetingNotes
                        ...
                        .map((note) => {
                          ...
                          const borderColor = isFollowUp
                            ? "border-orange-500"
                            : "border-blue-500";
                          const iconColor = isFollowUp
                            ? "text-orange-600"
                            : "text-blue-600";
                          const authorColor = isFollowUp
                          ...
                          return (
                            <div
                              key={note.id}
                              className={`p-3 bg-secondary/30 rounded-lg border-l-4 ${borderColor}`}
                            >
                              <div className="flex items-start gap-2">
                                {isFollowUp ? (
                                  <ListTodo
                                    className={`h-4 w-4 ${iconColor} mt-0.5`}
                                  />
                                ) : (
                                  <FileText
                                    className={`h-4 w-4 ${iconColor} mt-0.5`}
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                                    ...
                                    {note.author && (
                                      <span
                                        className={`text-xs font-medium ${authorColor}`}
                                      >
                                        {note.author}
                                      </span>
                                    )}
                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <Button
                                  ...
                                  onClick={() =>
                                    (window.location.href = `mailto:${attendee}`)
                                  }
                                >
